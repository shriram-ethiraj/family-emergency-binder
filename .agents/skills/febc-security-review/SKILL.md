...
4. Preserve authenticated encryption, KDF and AAD binding, bounded vault parsing, save conflict detection, session cleanup, and local-only assets unless the user explicitly changes the threat model.
